...
//   const handleRequestAction = (id, actionType) => {
//     setAlertConfig({
//       isOpen: true,
//       type: "confirm",
//       title: actionType === "approve" ? "تایید درخواست" : "رد درخواست",
//       message: actionType === "approve" ? "آیا از تایید این درخواست مطمئن هستید؟" : "آیا از عدم تایید این درخواست مطمئن هستید؟",
//       onConfirm: () => {
...
//           type: "success",
//           title: "عملیات موفق",
//           message: actionType === "approve" ? "درخواست با موفقیت تایید شد." : "درخواست تایید نشد و رد شد."
//         }));
//       }
//     });
//   };
...
//         {/* منو همبرگری: فقط در موبایل نمایش داده می‌شود و در سمت راست قرار گرفت */}
//         <button 
...
//                       <RequestComponent key={request.id} request={request} onAction={handleRequestAction} />
//                     ))
//                   ) : (
...
//           <img src="https://i.pravatar.cc/40?img=68" alt="پروفایل" className="w-full h-full object-cover" />
//         </div>
//       </div>
...
//                 <button onClick={alertConfig.onConfirm} className="py-2.5 px-4 bg-indigo-600 text-white rounded-xl hover:bg-indigo-700 transition-colors cursor-pointer">مطمئنم</button>
//                 <button onClick={closeAlert} className="py-2.5 px-4 bg-slate-100 text-slate-600 rounded-xl hover:bg-slate-200 transition-colors cursor-pointer">انصراف</button>
//               </div>
//             ) : (
...
const [requests, setRequests] = useState([
  ...
  onSave={handleSave}
  canEdit={true} // دکمه ویرایش ظاهر می‌شود و فیلدها قابل تغییر می‌شوند
/>
